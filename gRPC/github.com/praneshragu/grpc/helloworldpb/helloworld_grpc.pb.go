...
const (
	...
	Greeter_SayHelloManyTimes_FullMethodName = "/helloworld.Greeter/SayHelloManyTimes"
	Greeter_LongGreet_FullMethodName         = "/helloworld.Greeter/LongGreet"
	Greeter_GreetEveryone_FullMethodName     = "/helloworld.Greeter/GreetEveryone"
)
...
type GreeterClient interface {
	...
	SayHelloManyTimes(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HelloReply], error)
...
func (c *greeterClient) SayHelloManyTimes(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HelloReply], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[0], Greeter_SayHelloManyTimes_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type Greeter_SayHelloManyTimesClient = grpc.ServerStreamingClient[HelloReply]
...
type GreeterServer interface {
	...
	SayHelloManyTimes(*HelloRequest, grpc.ServerStreamingServer[HelloReply]) error
...
func (UnimplementedGreeterServer) SayHelloManyTimes(*HelloRequest, grpc.ServerStreamingServer[HelloReply]) error {
...
func _Greeter_SayHelloManyTimes_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GreeterServer).SayHelloManyTimes(m, &grpc.GenericServerStream[HelloRequest, HelloReply]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Greeter_SayHelloManyTimesServer = grpc.ServerStreamingServer[HelloReply]
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "helloworldpb/helloworld.proto",
}
